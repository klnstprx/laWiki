...
ViewModel.prototype.id = 'containerentrada';
ViewModel.prototype.children = [
    'componentedetallesentrada' // DetallesEntrada
    ,'componentelistacomentarios' // ListaComentarios
    ,'componenteaadircomentario' // formComentario
];

exports.register = function () {
    ko.components.register('c-containerentrada', {
        viewModel: {
