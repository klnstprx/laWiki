...
import { getWiki, getEntradasByWikiId } from "../api.js";
    ...
    return (
        <MainLayout>
            ...
            <section style={{ padding: "30px", backgroundColor: "white", margin: "20px 0", borderRadius: "8px" }}>
                ...
                <Typography variant="h6" style={{ fontWeight: "bold", marginBottom: "10px" }}>
                Descripción: <span style={{ fontWeight: "normal" }}>{wiki.description}</span>
                </Typography>

                <Typography variant="h6" style={{ fontWeight: "bold", marginBottom: "10px" }}>
                Categoría: <span style={{ fontWeight: "normal" }}>{wiki.category}</span>
                </Typography>
            </section>
            ...
            <section style={{ padding: "30px", backgroundColor: "white", marginBottom: "20px", borderRadius: "8px" }}>
                ...
                <List>
                    ...
                    <ListItem key={entradas.id} style={{ borderBottom: "1px solid #ddd", padding: "15px 0" }}>
                        <EntradaComponent
            ...
            >
                <h2 style={{ fontSize: "28px", marginBottom: "20px" }}>Añadir Entrada</h2>
